---
title: "[LeetCode] 641. Design Circular Deque (Python)"
excerpt: "array, linked-list, design, queue"

categories:
  - LeetCode
tags:
  - [python, array, linked-list, design, queue]
...
class MyCircularDeque:
    ...
    def insertFront(self, value: int) -> bool:
        ...
        if not self.isEmpty():  # 즉, size가 존재하면
